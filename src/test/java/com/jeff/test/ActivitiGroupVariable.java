...
public class ActivitiGroupVariable {
         ...
         @Test
         public void deploy(){
        	 Deployment deployment=repositoryService.createDeployment().addClasspathResource("diagrams/helloGroupVariable.bpmn").name("组任务分配变量").deploy();
         ...
         public void start(){
        	 //for(int i=0;i<5;i++){
                  ...
                  variable.put("userIds", "小黑 ,小黄,小红,小花");
        		 String processId=runtimeService.startProcessInstanceByKey("helloGroupVariable",variable).getId();
