...
public class Dome4 {
         ...
         @Test
         public void deploy(){
        	 InputStream inputStreamBpmn = this.getClass().getResourceAsStream("/diagrams/demo2.bpmn");  
             InputStream inputStreamPng = this.getClass().getResourceAsStream("/diagrams/demo2.png");  
             Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Service  
                             .createDeployment()//创建一个部署对象  
                             .name("多实例任务")//添加部署的名称  
                             .addInputStream("diagrams/demo2.bpmn", inputStreamBpmn)//  
                             .addInputStream("diagrams/demo2.png", inputStreamPng)//  
                             .deploy();//完成部署  
         ...
         @Test
          public void pickUp(){
        	  processEngine.getTaskService().claim("122502", "小b");
          }
         /**回退任务*/
         @Test
          public void goBack(){
