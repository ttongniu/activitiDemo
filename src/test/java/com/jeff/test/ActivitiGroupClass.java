...
public class ActivitiGroupClass {
         ...
         @Test
         public void deploy(){
        	 Deployment deployment=repositoryService.createDeployment().addClasspathResource("diagrams/helloGroupClass.bpmn").name("组任务分配使用类").deploy();
         ...
         public void start(){
        	 //for(int i=0;i<5;i++){
        		 String processId=runtimeService.startProcessInstanceByKey("helloGroupClass").getId();
